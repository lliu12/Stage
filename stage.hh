...
public:
  ...
  /**
   * If current pose not in free space, try to find a close pose that is. 
   * \copydoc AdjustPoseToFreeSpace()
   */
  
  bool AdjustPoseToFreeSpace(double rad, size_t max_iter = 0);   
